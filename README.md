...
+ [Что такое generics ?](all.md#что-такое-generics-)
+ [Что такое GetHashCode ?](all.md#что-такое-gethashcode-)
...
+ [Что такое Array, List, HashSet, Dictionary ? Приведите примеры использования этих структур данных. Какая сложность операций с ними (поиск, вставка, удаление) ?](types.md#что-такое-array-list-hashset-dictionary--приведите-примеры-использования-этих-структур-данных-какая-сложность-операций-с-ними-поиск-вставка-удаление-)
+ [Какие знаете коллекции ? ](types.md#какие-знаете-коллекции-)
