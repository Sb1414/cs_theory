...
+ [Что такое CLR ? Что такое IL ? Что такое CLS ?](all.md#что-такое-clr--что-такое-il--что-такое-cls-)
+ [Что такое managed code ? управляемый код](all.md#что-такое-managed-code-)
