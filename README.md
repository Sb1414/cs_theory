...
+ [Как запретить наследование от класса ?](all.md#как-запретить-наследование-от-класса-httpsdev-stationrucategoriescsharpcheatsheetcsharp-base-cheatsheet3402-)
+ [Разница между управляемым и неуправляемым кодом ?](all.md#разница-между-управляемым-и-неуправляемым-кодом-httpsdev-stationrucategoriescsharpcheatsheetcsharp-base-cheatsheet3379-)
