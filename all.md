...
+ [Как запретить наследование от класса ?](#как-запретить-наследование-от-класса-httpsdev-stationrucategoriescsharpcheatsheetcsharp-base-cheatsheet3402-)
+ [Разница между управляемым и неуправляемым кодом ?](#разница-между-управляемым-и-неуправляемым-кодом-httpsdev-stationrucategoriescsharpcheatsheetcsharp-base-cheatsheet3379-)
